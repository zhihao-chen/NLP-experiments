...
class Lookahead(Optimizer):
    ...
    """
    def __init__(self, optimizer, default: dict = None, params=None, alpha=0.5, k=6, pullback_momentum="none"):
        """
        ...
        self.param_groups = self.optimizer.param_groups if not params else params
        self.alpha = alpha
        self.k = k
        self.step_counter = 0

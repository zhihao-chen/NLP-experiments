...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer,
                                 ...
                                 sequence_a_segment_id=0, mask_padding_with_zero=True, do_lower_case=False):
...
class CnerProcessor(DataProcessor):
    ...
    def get_train_examples(self):
        """See base class."""
        return self._create_examples(self._read_text(os.path.join(self.data_dir, "train.char.bmes")), "train")

    def get_dev_examples(self):
        """See base class."""
        return self._create_examples(self._read_text(os.path.join(self.data_dir, "dev.char.bmes")), "dev")

    def get_test_examples(self):
        """See base class."""
        return self._create_examples(self._read_text(os.path.join(self.data_dir, "test.char.bmes")), "test")
    ...
    def get_labels(self):
        ...
        if os.path.exists(label_file):
            with codecs.open(label_file, encoding='utf8') as fr:
                for line in fr:
                    line = line.strip()
                    if not line:
                        continue
    ...
    def get_labels(self):
        ...
        if os.path.exists(label_file):
            ...
            labels = {"X", "B-address", "B-book", "B-company", 'B-game', 'B-government', 'B-movie', 'B-name',
                      'B-organization', 'B-position', 'B-scene', "I-address", "I-book", "I-company", 'I-game',
                      'I-government', 'I-movie', 'I-name', 'I-organization', 'I-position', 'I-scene',
                      "S-address", "S-book", "S-company", 'S-game', 'S-government', 'S-movie',
                      'S-name', 'S-organization', 'S-position', 'S-scene', 'O', "[START]", "[END]"}
        return labels
...
class NerProcessor(DataProcessor):
    ...
    def get_train_examples(self):
        """See base class."""
        if os.path.exists(os.path.join(self.data_dir, "train.json")):
            return self._create_examples(self._read_json(os.path.join(self.data_dir, "train.json")), "train")
        elif os.path.exists(os.path.join(self.data_dir, "train.txt")):
            return self._create_examples(self._read_text(os.path.join(self.data_dir, "train.txt")), "train")

    def get_dev_examples(self):
        """See base class."""
        if os.path.exists(os.path.join(self.data_dir, "dev.json")):
            return self._create_examples(self._read_json(os.path.join(self.data_dir, "dev.json")), "dev")

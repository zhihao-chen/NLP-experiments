...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        tokens = tokenize(words, tokenizer.vocab, do_lower_case)
        ...
        for subject in subjects:
            ...
            assert end < len(tokens), f"{end}, {len(tokens)}"
...
class CnerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        if os.path.exists(label_file):
            ...
            labels = ["O", "CONT", "ORG", "LOC", 'EDU', 'NAME', 'PRO', 'RACE', 'TITLE']
        return labels
...
class CluenerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        if os.path.exists(label_file):
            ...
            labels = ["O", "address", "book", "company", 'game', 'government', 'movie', 'name', 'organization',
                      'position', 'scene']
        return labels

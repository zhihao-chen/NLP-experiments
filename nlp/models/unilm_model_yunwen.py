...
"""
PyTorch UniLM model. 
From https://github.com/YunwenTechnology/Unilm/blob/master/modeling_unilm.py
"""
import copy
import math
import logging
...
from transformers.models.bert.modeling_bert import (load_tf_weights_in_bert, BertPooler, BertIntermediate,
                                                    BertOutput, BertSelfOutput, BertOnlyMLMHead, BertOnlyNSPHead,
                                                    BertEmbeddings)

from nlp.utils.configuration_unilm import UnilmConfigYunWen as UnilmConfig
...
class LabelSmoothingLoss(_Loss):
    ...
    def forward(self, output, target):
        ...
        return func.kl_div(output, model_prob.type_as(output), reduction='none').view(batch_size, num_pos, -1).sum(2)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None, masked_pos=None,
        ...
        if self.crit_mask_lm_smoothed:
            masked_lm_loss = self.crit_mask_lm_smoothed(
                func.log_softmax(prediction_scores_masked.float(), dim=-1), masked_lm_labels)
        else:
    ...
    def beam_search(self, input_ids, token_type_ids, position_ids, attention_mask):
        ...
        while next_pos < output_length:
            ...
            def select_beam_items(x, ids):
                ...
                y = torch.gather(x, 1, torch.tensor(ids, dtype=torch.int64))
        ...
        for b in range(batch_size):
            ...
            if frame_id == -1:
                ...
                for fid in range(frame_id, 0, -1):
                    ...
                    seq.append(wids_list[int(fid - 1)][pos_in_frame])
                seq.reverse()

...
common = {
    ...
    "hyper_parameters": {
        "shaking_type": "cat",
        # cat, cat_plus, cln, cln_plus; Experiments show that cat/cat_plus work better with BiLSTM,
        ...
        "inner_enc_type": "lstm",
        # valid only if cat_plus or cln_plus is set. It is the way how to encode inner tokens between each token pairs.
        # If you only want to reproduce the results, just leave it alone.
        "dist_emb_size": -1,
        # -1: do not use distance embedding; other number: need to be larger than the max_seq_len of the inputs.
...
train_config = {
    ...
    "logger": "default",
    "run_id": run_id,
    "log_path": "/data/chenzhihao/news_relation/logging_dir/default.log",
    "path_to_save_model": "/data/chenzhihao/news_relation/output/{}".format(run_id),
    ...
    "hyper_parameters": {
        ...
        # to speed up the training process, the loss of EH-to-ET sequence is set higher than other sequences at
        # the beginning, but it will recover in <loss_weight_recover_steps> steps.
        "scheduler": "CAWR",  # Step
    },
}

eval_config = {
    "model_state_dict_dir": "/data/chenzhihao/news_relation/output",
    ...
    "save_res": True,
    "save_res_dir": "/data/chenzhihao/news_relation/tplinker_results",
...
bert_config = {
    "data_home": "/data/chenzhihao/news_relation/datas/data4bert",

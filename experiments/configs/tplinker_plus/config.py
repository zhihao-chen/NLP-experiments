...
train_config = {
    ...
    "logger": "default",
    "run_id": run_id,
    "log_path": "/data/chenzhihao/NLP/experiments/output_file_dir/tplinker_log_dir/default.log",
    "path_to_save_model": "/data/chenzhihao/NLP/experiments/output_file_dir/tplinker_log_dir/{}".format(run_id),
...
eval_config = {
    "model_state_dict_dir": "/data/chenzhihao/NLP/experiments/output_file_dir/tplinker_log_dir",
    ...
    # results
    "save_res": False,
    "save_res_dir": "/data/chenzhihao/NLP/experiments/output_file_dir/tplinker",
...
bert_config = {
    "data_home": "/data/chenzhihao/NLP/experiments/datas/tplinker",
    "bert_path": "/data/chenzhihao/chinese-roberta-ext",  # bert-base-cased， chinese-bert-wwm-ext-hit
    "hyper_parameters": {
        "lr": 5e-5,
    },
}

...
# tokenizer = Tokenizer("/home/chenzhihao/chinese-bert-wwm", do_lower_case=True)
tokenizer = BertTokenizer("/data/chenzhihao/nezha-cn-base/vocab.txt", do_lower_case=True)
BERT_MAX_LEN = 512
rel_num = 3

...
@date: 2023/2/3 14:49
"""
# finetune chinese unilm model for seq2seq task
# reference：https://github.com/YunwenTechnology/Unilm/blob/master/run_seq2seq.py
import os
import sys
import logging
import glob
...
from nlp.models.unilm_model_yunwen import UnilmForSeq2Seq, UnilmConfig
from nlp.processors.unlim_yunwen_preprocessor import Preprocess4Seq2seq, Seq2SeqDataset, batch_list_to_batch_tensors

ALL_MODELS = sum((tuple(conf.pretrained_config_archive_map.keys())
                  for conf in (UnilmConfig,)), ())
MODEL_CLASSES = {
    'unilm': (UnilmConfig, UnilmForSeq2Seq, UniLMTokenizerYunWen)
}
...
def init_optimizer_and_scheduler(args, model, t_total):
    # Prepare optimizer
...
def main():
    ...
    if args.do_train:
        ...
        bi_uni_pipeline = [Preprocess4Seq2seq(args.max_pred, args.mask_prob, list(tokenizer.vocab.keys()),
        ...
        train_dataset = Seq2SeqDataset(file, args.train_batch_size, data_tokenizer,
        ...
        train(args, model_class, config, train_dataloader, train_sampler)

...
def get_argparse():
    ...
    parser.add_argument("--data_format", default=None, type=str, required=True,
                        help="The name of the data format")
    ...
    parser.add_argument("--logging_dir", default='logs/', type=str, help="The log dir for tensorboard")

    # Other parameters
    parser.add_argument('--markup', default='', type=str,
    ...
    parser.add_argument("--do_predict_no_tag", action="store_true",
                        help="Whether to run eval on the test set.")
    parser.add_argument("--do_predict_tag", action="store_true",
    ...
    parser.add_argument("--predict_checkpoints", type=int, default=0,
                        help="predict checkpoints starting with the same prefix as model_name ending "
                             "and ending with step number")
    ...
    parser.add_argument("--early_stop", action="store_true", help="Whether early stop the training")
    parser.add_argument("--tolerance", default=5, type=int,
                        help="What number of steps for early stop.")
    ...
    parser.add_argument("--scheduler_type", type=str, default="linear", help="The scheduler type to use.",
                        choices=["linear", "cosine", "cosine_with_restarts", "polynomial", "constant",
                                 "constant_with_warmup"])
    parser.add_argument("--no_cuda", action="store_true", help="Avoid using CUDA when available")
    parser.add_argument("--cuda_number", default="0", type=str)

...
def top_filtering(logits, top_k=0, top_p=0.0, threshold=-float('Inf'), filter_value=-float('Inf')):
    """ Filter a distribution of logits using top-k, top-p (nucleus) and/or threshold filtering
        Args:
            ...
            :param top_p: <=0.0: no filtering, >0.0: keep only a subset S of candidates, where S is the smallest subset
...
if __name__ == "__main__":
    ...
    model_path = f"{root_path}/datas/output_dir/CDail-GPT-QA"
    ...
    parser.add_argument("--max_length", type=int, default=256, help="Maximum length of the output utterances")

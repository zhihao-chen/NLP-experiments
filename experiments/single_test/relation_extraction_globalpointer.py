...
======================================
    Project Name: NLP
    File Name: relation_extraction_globalpointer
    Author: czh
...
maxlen = 256
batch_size = 10
config_path = '/data/chenzhihao/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/data/chenzhihao/chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/data/chenzhihao/chinese_L-12_H-768_A-12/vocab.txt'
...
data_path = "/data/chenzhihao/NLP/datas"
# 加载数据集
train_data = load_data(data_path + '/kg/train_data.json')
valid_data = load_data(data_path + '/kg/dev_data.json')

with open(data_path + '/kg/all_50_schemes.json') as f:
    alist = json.load(f)

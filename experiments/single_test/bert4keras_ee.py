...
root = "/data/chenzhihao"
# root = "/Users/czh/Downloads"
# bert配置
config_path = root + '/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = root + '/chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = root + '/chinese_L-12_H-768_A-12/vocab.txt'
...
# 读取数据
train_data = load_data('../../datas/duee1/train.json')
valid_data = load_data('../../datas/duee1/dev.json')

# 读取schema
with open('../../datas/duee1/event_schema.json') as f:
...
if __name__ == '__main__':
    ...
    train_generator = data_generator(train_data[:100], batch_size)
    evaluator = Evaluator()

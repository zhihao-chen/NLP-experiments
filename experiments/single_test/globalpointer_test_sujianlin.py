...
======================================
    Project Name: NLP
    File Name: globalpointer_test_sujianlin
    Author: czh
...
# bert配置
config_path = '/Users/czh/Downloads/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/Users/czh/Downloads/chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/Users/czh/Downloads/chinese_L-12_H-768_A-12/vocab.txt'
...
# 标注数据
train_data = load_data('/experiments/datas/cluener/train.json')
valid_data = load_data('/experiments/datas/cluener/dev.json')
